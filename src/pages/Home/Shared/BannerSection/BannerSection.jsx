            ...
            <div className="hero min-h-[70vh]" style={{ backgroundImage: `url(${backgroundImageUrl})` }}>
                ...
                <div className="hero-content text-start text-neutral-content">
                    <div className="max-w-xl">
                        <h1 className="mb-5 font-serif text-white text-3xl md:text-4xl font-bold">{activeBanner?.title}</h1>
                        <p className="mb-5 font-serif text-white text-base">{activeBanner?.details}</p>
